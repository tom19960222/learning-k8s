...
export const PROJECTS: Record<ProjectId, ProjectMeta> = {
  ...
  'ceph': {
    ...
    featureGroups: [
      ...
      { label: '監控與告警', icon: '📟', slugs: ['prometheus-alert-design', 'prometheus-alert-testing'] },
