...
export const PROJECTS: Record<ProjectId, ProjectMeta> = {
  ...
  'ceph': {
    ...
    features: ['architecture', 'crush-and-placement', 'crush-straw-straw2', 'pool-pgnum-pgpnum', 'osd-and-bluestore', 'bluestore-deep-dive', 'mclock-osd-scheduler', 'recovery-throttle-runtime', 'osd-flapping', 'pg-health-states', 'mon-clock-skew-detection', 'cluster-time-skew-impact', 'mon-quorum-loss-impact', 'osd-ok-to-stop', 'osd-safe-to-destroy', 'prometheus-alert-design', 'rbd-and-csi'],
    featureGroups: [
      { label: '從這裡開始', icon: '🚀', slugs: ['architecture'] },
      ...
      { label: '故障偵測與恢復', icon: '🚨', slugs: ['osd-flapping', 'pg-health-states', 'mon-clock-skew-detection', 'cluster-time-skew-impact', 'mon-quorum-loss-impact'] },
  ...
  'systemd': {
    ...
    features: ['timesyncd-restart-impact', 'timesyncd-log-anatomy'],
    featureGroups: [
      { label: '時間同步 (timesyncd)', icon: '🕒', slugs: ['timesyncd-restart-impact', 'timesyncd-log-anatomy'] },
    ],
    usecases: [],
    difficulty: '🟡 中階',
    difficultyColor: 'text-yellow-400 bg-yellow-400/10 border-yellow-400/30',
