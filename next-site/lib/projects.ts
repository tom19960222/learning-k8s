...
export const PROJECTS: Record<ProjectId, ProjectMeta> = {
  ...
  'ceph': {
    ...
    features: ['architecture', 'crush-and-placement', 'crush-straw-straw2', 'pool-pgnum-pgpnum', 'osd-and-bluestore', 'bluestore-deep-dive', 'rbd-datapath-and-csi', 'osd-flapping', 'pg-health-states', 'mon-clock-skew-detection', 'cluster-time-skew-impact', 'clock-skew-failure-modes', 'mon-quorum-loss-io-lab', 'mon-quorum-detection-blind-spot', 'mclock-osd-scheduler', 'recovery-throttle-and-mclock', 'slow-ops-detection-mechanisms', 'slow-ops-fast-detection-lab', 'ceph-alert-policy-current', 'ceph-alert-validation-methodology', 'ceph-alert-real-lab-report', 'osd-ok-to-stop', 'osd-safe-to-destroy', 'incident-bundle-operator-runbook', 'incident-bundle-validation-report', 'slow-ops-and-bluestore-alerts', 'prometheus-alert-design', 'prometheus-alert-testing', 'prometheus-alert-real-lab-findings', 'prometheus-alert-real-cluster', 'mon-quorum-loss-impact', 'clock-skew-magnitude-ladder', 'recovery-throttle-runtime', 'rbd-and-csi', 'incident-bundle-runbook'],
    featureGroups: [
      { label: '從這裡開始', icon: '🚀', slugs: ['architecture'] },
