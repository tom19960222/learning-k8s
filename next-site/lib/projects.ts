...
export const PROJECTS: Record<ProjectId, ProjectMeta> = {
  ...
  'ceph': {
    ...
    features: ['architecture', 'crush-and-placement', 'crush-straw-straw2', 'pool-pgnum-pgpnum', 'osd-and-bluestore', 'bluestore-deep-dive', 'mclock-osd-scheduler', 'recovery-throttle-runtime', 'osd-flapping', 'pg-health-states', 'mon-clock-skew-detection', 'cluster-time-skew-impact', 'clock-skew-magnitude-ladder', 'mon-quorum-loss-impact', 'osd-ok-to-stop', 'osd-safe-to-destroy', 'prometheus-alert-design', 'prometheus-alert-testing', 'prometheus-alert-real-lab-findings', 'prometheus-alert-real-cluster', 'mon-quorum-detection-blind-spot', 'slow-ops-and-bluestore-alerts', 'incident-bundle-runbook', 'rbd-and-csi', 'slow-ops-detection-mechanisms', 'slow-ops-fast-detection-lab', 'ceph-alert-policy-current', 'ceph-alert-validation-methodology', 'ceph-alert-real-lab-report', 'mon-quorum-loss-io-lab', 'clock-skew-failure-modes', 'recovery-throttle-and-mclock', 'rbd-datapath-and-csi'],
    featureGroups: [
      { label: '從這裡開始', icon: '🚀', slugs: ['architecture'] },
