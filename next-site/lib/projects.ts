...
export const PROJECTS: Record<ProjectId, ProjectMeta> = {
  ...
  'ceph': {
    ...
    features: ['architecture', 'crush-and-placement', 'osd-and-bluestore', 'bluestore-deep-dive', 'mclock-osd-scheduler', 'recovery-throttle-runtime', 'osd-flapping', 'pg-health-states', 'osd-ok-to-stop', 'osd-safe-to-destroy', 'rbd-and-csi'],
    featureGroups: [
      { label: '從這裡開始', icon: '🚀', slugs: ['architecture'] },
      ...
      { label: '故障偵測與恢復', icon: '🚨', slugs: ['osd-flapping', 'pg-health-states'] },
